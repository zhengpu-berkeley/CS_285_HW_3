...
class DQNCritic(BaseCritic):
    ...
    def update(self, ob_no, ac_na, next_ob_no, reward_n, terminal_n):
        ...
        if self.double_q:
            ...
            est_q_nxt_t = self.q_net(next_ob_no)
            est_ac_nxt_t = est_q_nxt_t.argmax(1)
            # qvalue of next time step
            q_tp1 = torch.gather(qa_tp1_values, 1, est_ac_nxt_t.unsqueeze(1)).squeeze(1)
        else:
